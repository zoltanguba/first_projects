...
LANGUAGE_CHOICES = (('', ''), ('af', 'Afrikaans'), ('sq', 'Albanian'), ('am', 'Amharic'), ('ar', 'Arabic'),
                    ('hy', 'Armenian'),
                    ...
                    ('no', 'Norwegian'), ('ny', 'Nyanja (Chichewa)'), ('ps', 'Pashto'), ('fa', 'Persian'),
                    ('pl', 'Polish'), ('pt', 'Portuguese (Portugal, Brazil)'), ('pa', 'Punjabi'), ('ro', 'Romanian'),
                    ...
                    ('sv', 'Swedish'), ('tl', 'Tagalog (Filipino)'), ('tg', 'Tajik'), ('ta', 'Tamil'), ('te', 'Telugu'),
...
class WordTranslationForm(forms.ModelForm):
    class Meta:
        model = WordDatabase
        fields = [
            "srcLanguage",
...
class DestinationLanguageForm(forms.ModelForm):
    destLanguage = forms.ChoiceField(
        required=True,
        choices=LANGUAGE_CHOICES,
    )
